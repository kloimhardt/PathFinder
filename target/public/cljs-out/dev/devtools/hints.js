...
var file = cljs.core.get.call(null,map__13279__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e13278){var _e = e13278;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___13281 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___13281)){
var seen_errors_13282 = temp__5718__auto___13281;
if(cljs.core.truth_(seen_errors_13282.has(self))){
} else {
seen_errors_13282.add(self);

var temp__5720__auto___13283 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___13283)){
var sense_13284 = temp__5720__auto___13283;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13284)].join('');
} else {
}
}
} else {
