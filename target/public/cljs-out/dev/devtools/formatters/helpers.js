...
var G__10743 = devtools.prefs.pref.call(null,v);
v = G__10743;
continue;
} else {
return v;
...
}catch (e10746){var _e__9757__auto__ = e10746;
return false;
}})();
...
}catch (e10750){var _e__9757__auto__ = e10750;
return false;
}})();
...
}catch (e10752){var _e__9757__auto__ = e10752;
return false;
}}
}
});
...
var vec__10754 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10754,(0),null);
var name = cljs.core.nth.call(null,vec__10754,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10757_SHARP_);
}),template);
});
