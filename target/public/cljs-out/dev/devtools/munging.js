...
var o10638 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10638["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10639 = temp__5718__auto____$1;
return (o10639["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9750__auto__ = f;
return (o__9750__auto__["toString"]).call(o__9750__auto__);
} else {
return "";
}
}catch (e10640){var _ = e10640;
return "";
}});
...
try{var o__9750__auto___10642 = t;
(o__9750__auto___10642["cljs$lang$ctorPrWriter"]).call(o__9750__auto___10642,t,writer);
}catch (e10641){var __10643 = e10641;
}
...
var char_code = (function (){var o__9750__auto__ = (new String(char$));
return (o__9750__auto__["charCodeAt"]).call(o__9750__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9750__auto__ = String;
return (o__9750__auto__["fromCharCode"]).call(o__9750__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10644 = num_code;
switch (G__10644) {
case (1):
return (185);
...
var o__9750__auto__ = String;
return (o__9750__auto__["fromCharCode"]).call(o__9750__auto__,superscript_code);
});
/**
...
}catch (e10646){var _e__9757__auto__ = e10646;
return false;
}})())){
...
var vec__10647 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10647,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o10650 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10650["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10651 = temp__5718__auto____$1;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10654){
var vec__10655 = p__10654;
var ns_detector = cljs.core.nth.call(null,vec__10655,(0),null);
...
var G__10661 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10662 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10661;
remaining_tokens = G__10662;
continue;
}
}
break;
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10653,seq10652__$1);
});
...
var vec__10666 = cljs.core.split_with.call(null,(function (p1__10665_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10665_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10666,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10666,(1),null);
...
var vec__10672 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10672,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10672,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10675 = cljs.core.rest.call(null,remaining_tokens);
var G__10676 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10675;
name_tokens = G__10676;
continue;
} else {
...
var vec__10679 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10679,(0),null);
var arity = cljs.core.nth.call(null,vec__10679,(1),null);
var vec__10682 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10682,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10682,(1),null);
var vec__10685 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10685,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10685,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10685,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10685,(3),null);
...
var vec__10691 = result;
var munged_ns = cljs.core.nth.call(null,vec__10691,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10691,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10691,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10691,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10691,(4),null);
var arity = cljs.core.nth.call(null,vec__10691,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__10695 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__10695,(0),null);
var args = cljs.core.nth.call(null,vec__10695,(1),null);
var vec__10698 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10698,(0),null);
var name = cljs.core.nth.call(null,vec__10698,(1),null);
...
var G__10701 = (arity + (1));
var G__10702 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10703){
var vec__10704 = p__10703;
var arity = cljs.core.nth.call(null,vec__10704,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10704,(1),null);
...
return cljs.core.get.call(null,arities,p1__10707_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10708_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10711){
var vec__10712 = p__10711;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10712,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10709){
...
var G__10718 = arg;
var G__10718__$1 = (((G__10718 instanceof cljs.core.Keyword))?G__10718.fqn:null);
switch (G__10718__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10721 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10721,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10721,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10721,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10721,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10721,(4),null);
var arity = cljs.core.nth.call(null,vec__10721,(5),null);
...
var o__9750__auto__ = f;
return (o__9750__auto__["getBasis"]).call(o__9750__auto__);
});
/**
...
}catch (e10725){var _e__9757__auto__ = e10725;
...
var G__10726 = (obj[cljs.core.first.call(null,path)]);
var G__10727 = cljs.core.rest.call(null,path);
obj = G__10726;
path = G__10727;
continue;
} else {
...
return (function (accum,p__10728){
var vec__10729 = p__10728;
var bit = cljs.core.nth.call(null,vec__10729,(0),null);
var protocol = cljs.core.nth.call(null,vec__10729,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10732){
var vec__10733 = p__10732;
var ns = cljs.core.nth.call(null,vec__10733,(0),null);
var name = cljs.core.nth.call(null,vec__10733,(1),null);
var selector = cljs.core.nth.call(null,vec__10733,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__10738,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10738,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10738,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10736_SHARP_){
return (obj[cljs.core.first.call(null,p1__10736_SHARP_)]);
});})(name,sorted_matches,vec__10738,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
